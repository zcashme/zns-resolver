//! Public API DTOs for the ZNS JSON-RPC interface.
//!
//! These types define the contract exposed to clients. They are intentionally
//! decoupled from internal storage types in the registry.
