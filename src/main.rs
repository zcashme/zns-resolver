...
/// Registry name-note account **full viewing key** (UFVK). Pure UIVK is no
/// longer supported — the FVK is required for the self-send (OVK) authorization
/// check on name notes.
const UFVK: &str = "";
...
async fn main() {
    ...
    let orchard_fvk = fvk.orchard().expect("name-note UFVK must have an Orchard component");
